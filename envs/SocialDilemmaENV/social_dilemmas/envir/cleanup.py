...
from SocialDilemmaENV.social_dilemmas.constants import CLEANUP_MAP
from SocialDilemmaENV.social_dilemmas.envs.map_env import MapEnv, ACTIONS
from SocialDilemmaENV.social_dilemmas.envs.agent import CleanupAgent  # CLEANUP_VIEW_SIZE
